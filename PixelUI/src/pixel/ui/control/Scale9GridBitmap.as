package pixel.ui.control
{
	...
	public class Scale9GridBitmap extends Sprite
	{
		...
		public function Scale9GridBitmap(source:BitmapData)
		{
			//保存原图
			_source = source;
...
//			RightBottom = GetBitmap(RightTop.x,RightCenter.y + RightCenter.height,Right,Bottom);
			...
			//addChild(LeftTop);
			LeftCenter.RectUpdate(0,Top,Left,(_source.height - Top - Bottom));
			//addChild(LeftCenter);
			LeftBottom.RectUpdate(0,Top + LeftCenter.height,Left,Bottom);
			//addChild(LeftBottom);
			
			CenterTop.RectUpdate(Left,0,(_source.width - Left - Right),Top);
			//addChild(CenterTop);
