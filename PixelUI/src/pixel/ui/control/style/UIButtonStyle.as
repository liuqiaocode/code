package pixel.ui.control.style
{
	...
	public class UIButtonStyle extends UIStyle
	{
		...
		public function UIButtonStyle()
		{
			...
			_OverStyle.LeftBottomCorner = _OverStyle.LeftTopCorner = _OverStyle.RightBottomCorner = _OverStyle.RightTopCorner = 2;
			_PressStyle.LeftBottomCorner = _PressStyle.LeftTopCorner = _PressStyle.RightBottomCorner = _PressStyle.RightTopCorner = 2;
			LeftBottomCorner = LeftTopCorner = RightBottomCorner = RightTopCorner = 2;
		}
