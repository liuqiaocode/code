package pixel.ui.control.style
{
	...
	public class UIStyle implements IVisualStyle
	{
		...
		private var _BorderColor:uint = 0xcbcbcb;
		//边框颜色
...
//		}
		...
		private var _BackgroundImage:BitmapData = null;
		//背景图片
...
//		}
		...
		{
			return (_BackgroundImageId || _BackgroundImage);
		}
		/**
		 * 序列化接口
		 **/
		...
		public function decodeXML(value:String):void
		{
		}
...
//					_HaveImage = true;
					...
					if(_ImagePack)
					{
						...
						_BackgroundImage = new BitmapData(ImgWidth,ImgHeight);
						_BackgroundImage.setPixels(_BackgroundImage.rect,ImgData);
