package pixel.ui.control
{
	...
	{
		private var _items:Vector.<IUIComboboxItem> = new Vector.<IUIComboboxItem>();
		//private var _LastMove:UIComboboxItem = null;
		private var _FocusColor:uint = 0xFFFFFF;
		private var _itemPrototype:Object = null;
		/**
		 * 
		 * @param		itemPrototype		子项原型
		 **/
		public function UIComboboxPop(itemPrototype:Object = null)
		{
			super();
			...
			_itemPrototype = itemPrototype ? itemPrototype:UIComboboxItem;
		}
...
//			}
		...
		public function appendItem(data:Object):IUIComboboxItem
		{
			//var item:IUIComboboxItem = new 
			var item:IUIComboboxItem = instanceItem();
			item.itemData = data;
			_items.push(item);
...
//			Item.x = 5;
//			Item.y += 5;
//			height = (_children.length + 1) * _ItemHeight + _children.length * 5;
			return item;
		}
...
//			}
		...
		protected function instanceItem():IUIComboboxItem
		{
			if(_itemPrototype is IUIControl)
			{
				return IUIControl(_itemPrototype).clone() as IUIComboboxItem;
			}
			else
			{
				return new _itemPrototype() as IUIComboboxItem;
			}
		}
		
		protected function updateSize():void
		{
			var maxHeight:int = this.padding;
