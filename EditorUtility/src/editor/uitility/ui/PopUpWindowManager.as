...
//			}
			...
			Window.addEventListener(EditorUtilityEvent.WINDOW_CLOSE,WindowClose);
		...
		private static function WindowClose(event:EditorUtilityEvent):void
		{
			var Window:IFlexDisplayObject = event.currentTarget as IFlexDisplayObject;
			if(Window)
			{
				Window.removeEventListener(EditorUtilityEvent.WINDOW_CLOSE,WindowClose);
